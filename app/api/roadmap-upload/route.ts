...
const uploadsDir = join(process.cwd(), 'public', 'uploads', 'roadmaps');
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      slug,
      filename,
      url: `/uploads/roadmaps/${filename}`,
      message: 'Roadmap image uploaded successfully',
    });
  } catch (error) {
