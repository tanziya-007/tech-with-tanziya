...
export default function ProjectUploadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('title', projects.find(p => p.slug === slug)?.title || slug);
  ...
  const handleDelete = async (uploadSlug: string) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage('✓ Project image deleted successfully');
        fetchUploads();
        setTimeout(() => setMessage(''), 3000);
      } else {
        setMessage('✗ Failed to delete project image');
      }
    } catch (error) {
      ...
      <main>
        ...
        <div className="container admin-container">
          <div className="admin-header">
            <h1 className="admin-title">🚀 Project Upload</h1>
          ...
          <div className="admin-grid">
            <div className="upload-form">
              <h2 className="form-title">Upload Project Image</h2>
              ...
              <form onSubmit={handleSubmit}>
                <div className="form-group">
                  <label htmlFor="slug">Select Project</label>
                  <select
                    id="slug"
                    value={slug}
            ...
            <div className="uploads-list">
              <h2 className="uploads-title">Uploaded Projects</h2>

              {uploads.length === 0 ? (
                <div className="empty-state">
                  <p>No project images uploaded yet</p>
                </div>
              ) : (
                uploads.map((upload) => (
