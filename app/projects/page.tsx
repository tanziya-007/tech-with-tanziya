...
.roadmap-grid { display: grid; gap: 30px; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); position: relative; z-index: 1; }
...
.roadmap-body { padding: 35px; display: flex; flex-direction: column; flex: 1; }
.roadmap-number { font-size: 13px; font-weight: 700; color: var(--primary); letter-spacing: 1px; margin-bottom: 12px; }
.roadmap-body h2 { font-size: 22px; font-weight: 700; color: var(--text); margin-bottom: 12px; transition: color 0.3s ease; }
.roadmap-body p { color: var(--text-secondary); line-height: 1.7; font-size: 15px; flex: 1; transition: color 0.3s ease; }
.roadmap-footer { margin-top: 30px; color: var(--primary); font-weight: 700; font-size: 14px; transition: color 0.3s ease; }
